...
@section('content')
   ...
   <div class="flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md p-6 m-4 bg-white rounded-lg shadow-md lg:max-w-xl">
        <h2 class="text-3xl font-bold text-center text-gray-700">Create Blog Post</h2>
        <form action="/post/store" method="POST" class="mt-6">
            @csrf
            <div>
                <label for="title" class="block text-sm text-gray-700">Title</label>
                <input type="text" placeholder="Enter your blog post title" id="title" name="titre"
            ...
            <div class="mt-4">
                ...
                <textarea id="content" placeholder="Write your blog post here..." name="contenu"
                       class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md focus:border-blue-500 focus:ring-blue-500"></textarea>
            </div>
